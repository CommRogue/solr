...
import static org.commrogue.indexanalyzer.lucene.Utils.*;
...
import org.commrogue.indexanalyzer.analysis.exceptions.NonBlockTreeException;
import org.commrogue.indexanalyzer.results.FieldAnalysis;
import org.commrogue.indexanalyzer.results.IndexAnalysisResult;
import org.commrogue.indexanalyzer.results.InvertedIndexFieldAnalysis;
...
public class InvertedIndexAnalysis implements Analysis {
    ...
    public void analyze() throws IOException, NonBlockTreeException {
        ...
        boolean hasCandidateField = false;
        for (FieldInfo fieldInfo : fieldInfos) {
            if (fieldSelector.includes(fieldInfo.name) && fieldInfo.getIndexOptions() != IndexOptions.NONE) {
