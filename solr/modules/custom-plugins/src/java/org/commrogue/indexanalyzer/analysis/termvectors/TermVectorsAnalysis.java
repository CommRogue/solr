package org.commrogue.indexanalyzer.analysis.termvectors;
...
import org.commrogue.indexanalyzer.results.TermVectorsFieldAnalysis;
...
public class TermVectorsAnalysis implements Analysis {
    ...
    public void analyze() throws Exception {
        ...
        TermVectorSizeEstimator estimator = new TermVectorSizeEstimator(directory, segmentReader, fieldSelector);
    ...
    private static final class TermVectorSizeEstimator {
        ...
        private TermVectorSizeEstimator(
        ...
        private Map<String, DocFieldStats> collectDocFieldStats(Fields termVectors) throws IOException {
            ...
            while (iterator.hasNext()) {
                ...
                if (!fieldSelector.includes(field)) {
                    continue;
                }
