...
public class TopKeysTrackingCache<K, V> extends SolrCacheBase
  ...
  public void initializeMetrics(SolrMetricsContext parentContext, Attributes attributes) {
    initializeMetrics(parentContext, attributes, "solr_topkeys_cache");
  }

  // Mirrors Solr 10's CaffeineCache.initializeMetrics: cumulative lookups and operations as
  // counters split by result/operation attributes, point-in-time size and RAM as gauges, all
  // recorded from one batch callback.
